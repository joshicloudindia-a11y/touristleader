    ...
    try {
      await prisma.booking.create({
        data: {
          ...
          paymentMethod: razorpayPaymentId ? "razorpay" : "test",
          paymentStatus: razorpayPaymentId ? "PAID" : "TEST",
          contactEmail,
  ...
  try {
    await prisma.booking.create({
      data: {
        ...
        baseFare: fareTotal, taxes, addOns: 0, totalAmount: grand,
        paymentId: razorpayPaymentId || null, paymentOrderId: razorpayOrderId || null,
        paymentMethod: razorpayPaymentId ? "razorpay" : "test", paymentStatus: razorpayPaymentId ? "PAID" : "TEST",
