...
import { Plane, BedDouble, Palmtree, Bus, StickyNote, Car, CreditCard, ShieldCheck, ChevronDown, LayoutGrid } from "lucide-react";
...
const TABS = [
  ...
  { id: "cabs", label: "Cabs", icon: Car, href: "/cabs" },
